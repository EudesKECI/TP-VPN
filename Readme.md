...
* [Partie 4 : L'infrastructure DNS](#partie-4--linfrastructure-dns)
  * [4.1 Étape 1 : S3 en serveur DNS Cache (Bind9)](#41-étape-1--s3-en-serveur-dns-cache-bind9)
  * [4.2 Étape 2 : Le Serveur DNS Interne (sur S5)](#42-étape-2--le-serveur-dns-interne-sur-s5)
  * [Étape 3 : Test de ssh de C1](#étape-3--test-de-ssh-de-c1)
* [Configuration finale du serveur VPN (S4)](#configuration-finale-du-serveur-vpn-s4)
* [Test de résilience (Coupure de l'interface physique)](#test-de-résilience-coupure-de-linterface-physique)
* [WireGuard](#wireguard)
  ...
  * [Q2](#q2)
  * [Redirection du trafic (AllowedIPs = 0.0.0.0/0)](#redirection-du-trafic-allowedips--00000)
  * [Q3](#q3)
  * [Rétablissement du tunnel (Stateless vs Stateful)](#rétablissement-du-tunnel-stateless-vs-stateful)
  * [Q4](#q4)
  * [Q5](#q5)
* [Comparaison des fichiers de configurations finaux des serveurs](#comparaison-des-fichiers-de-configurations-finaux-des-serveurs)
